...
class CreateBrandForm extends StatefulWidget {
  ...
  const CreateBrandForm({required this.brandImageUploaderService, super.key});
...
class _CreateBrandFormState extends State<CreateBrandForm> {
  ...
  void _initializeDraftBrand() async {
    final createBrandFormBloc = context.read<CreateBrandFormBloc>();
    ...
    if (userId != null) {
      ...
      createBrandFormBloc.add(CreateDraftBrand(draftBrand));
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                CreateBrandImageUpload(
                  brandImageUploaderService: widget.brandImageUploaderService,
                  brandId: brandId ?? '',
                ),
                const SizedBox(height: 16),
                _buildTextInput(
