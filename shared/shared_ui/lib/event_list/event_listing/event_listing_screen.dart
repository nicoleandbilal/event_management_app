...
import 'package:shared/event_list/event_listing/bloc/event_listing_bloc.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Event image
          event.eventCoverImageCroppedUrl != null && event.eventCoverImageCroppedUrl!.isNotEmpty
              ? Image.network(event.eventCoverImageCroppedUrl!)
              : const Placeholder(
                  fallbackHeight: 200,
